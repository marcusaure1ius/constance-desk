...
Перепиши название так, чтобы оно начиналось с глагола в повелительном наклонении и читалось с одного взгляда. Убери канцелярит («нужно», «надо», «необходимо»), слова-паразиты и хвосты вроде «там ПСН добавился».

Смысл менять нельзя: ни новых деталей, ни выброшенных. Имена, аббревиатуры и названия систем оставляй как есть. Язык — тот же, что во входе.
